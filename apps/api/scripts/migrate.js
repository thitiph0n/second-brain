...
if (!['development', 'production'].includes(environment)) {
  console.error(
    '❌ Invalid environment. Use --env development or --env production'
  );
  process.exit(1);
}
...
if (environment === 'production') {
  console.log(
    '⚠️  WARNING: You are about to run migrations on PRODUCTION database!'
  );
  console.log(
    '   Make sure you have tested these migrations in development first.'
  );
